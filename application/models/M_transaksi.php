...
class M_transaksi extends CI_Model
{
    ...
    public function get()
    {
        $this->db->select("t.id_transaksi,t.id_mobil,m.plat_mobil,s.id_supir,s.nama_supir,t.tanggal,t.ket_transaksi,t.tujuan,t.ongkosan,t.keluar,t.sisa,t.sender");
	...
	public function update($post)
	{
		   $this->id_transaksi    = $post['id_transaksi']; 
			...
			$this->ket_transaksi     = $post['ket_transaksi'];
			$this->tujuan     = $post['tujuan'];
			$this->ongkosan     = $post['ongkosan'];
			$this->keluar     = $post['keluar'];
			$this->sisa     = $post['sisa'];
